...
Source of truth: `docs/ARCHITECTURE.yaml`. Tracking: [Project #24](https://github.com/users/googa27/projects/24), [MailReader issue](https://github.com/googa27/MailReader/issues/1). Profile: `legacy`; enforcement: `Advisory`.
...
- AI: Minimal AGENTS explaining current skeleton and revival gate; no MCP/plugin.
- Human/notebook: No stable API yet; plan typed message/evidence interfaces only on revival.
- Planned Python protocols: No new dunders until revival into a typed package; mail/network effects remain named methods.
- Core posture: Avoid core dependencies.
- Data posture: No current data architecture; revival requires private-email classification, retention, and local custody plan.
